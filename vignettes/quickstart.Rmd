...
`declared = TRUE, cached = FALSE` is work still to do on this machine. A row
with `declared = FALSE` is a copy of a version nothing asks for any more, which
is what the retention sweeps reclaim first.
